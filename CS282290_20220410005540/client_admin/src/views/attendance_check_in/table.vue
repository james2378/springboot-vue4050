<template>
	<el-main class="bg table_wrap">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="考勤状态">
						<el-select v-model="query.attendance_status">
                            <el-option v-for="o in list_attendance_status" :key="o" :label="o"
                            	:value="o">
                            </el-option>
						</el-select>
					</el-form-item>
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/attendance_check_in/table','add') || $check_action('/attendance_check_in/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/attendance_check_in/table','del') || $check_action('/attendance_check_in/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="attendance_status" label="考勤状态"
				v-if="user_group == '管理员' || $check_field('get','attendance_status')" min-width="200">
			</el-table-column>
			...
			<el-table-column label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/attendance_check_in/table','set') || $check_action('/attendance_check_in/view','set') || $check_action('/attendance_check_in/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/attendance_check_in/table','set') || $check_action('/attendance_check_in/view','set') || $check_action('/attendance_check_in/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/attendance_check_in/get_list?like=0",
				url_del: "~/api/attendance_check_in/del?",
		...
		methods: {
			...
			export_db(tableid){
				...
				// this.$get("~/api/attendance_check_in/export_db?",query,(json)=>{
				// 	if(json.result){
