<template>
	<el-main class="bg table_wrap">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/teacher/table','add') || $check_action('/teacher/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/teacher/table','del') || $check_action('/teacher/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/teacher/table','set') || $check_action('/teacher/view','set') || $check_action('/teacher/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
