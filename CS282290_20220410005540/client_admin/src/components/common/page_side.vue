<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/hospital_leaders/table" v-show="user_group == '管理员' || $check_action('/hospital_leaders/table')"><span>院领导</span></el-menu-item>
			<el-menu-item index="/instructor/table" v-show="user_group == '管理员' || $check_action('/instructor/table')"><span>辅导员</span></el-menu-item>
